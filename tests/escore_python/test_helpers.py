...
from escore.helpers import apply_transform_funcs, process_transform_funcs
...
class TransformFuncsTest(unittest.TestCase):
    ...
    @mock.patch('escore.helpers.type')
    @mock.patch('escore.helpers.process_transform_funcs')
