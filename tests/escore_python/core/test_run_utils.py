...
from escore.core.definitions import USER_OPTS, USER_OPTS_SHORT, USER_OPTS_KWARGS
...
class CommandLineArgumentTest(unittest.TestCase):
    ...
    @mock.patch.dict('escore.core.definitions.USER_OPTS_KWARGS', clear=True)
    @mock.patch.dict('escore.core.definitions.USER_OPTS_SHORT', clear=True)
