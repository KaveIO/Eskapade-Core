...
from escore.core.definitions import (CONFIG_VARS, CONFIG_TYPES, CONFIG_DEFAULTS, USER_OPTS,
                                       USER_OPTS_CONF_KEYS,
...
from escore.core.process_services import ProcessServiceMeta, ProcessService, ConfigObject, DataStore
...
class ProcessServiceTest(unittest.TestCase):
    ...
    @mock.patch('escore.core.process_services.ProcessService.__init__')
    ...
    @mock.patch('escore.core.process_services.open')
    ...
    @mock.patch('escore.core.process_services.open')
    @mock.patch('escore.core.process_services.type')
...
class ConfigObjectTest(unittest.TestCase):
    ...
    @unittest.skip('TODO (v0.8): this test tests job configuration and '
                   ...
                   'is refactored.')
    @mock.patch.dict('escore.core.definitions.CONFIG_DEFAULTS', clear=True)
    @mock.patch.dict('escore.core.definitions.CONFIG_VARS', clear=True)
    ...
    @mock.patch.dict('escore.core.definitions.USER_OPTS', clear=True)
    @mock.patch.dict('escore.core.definitions.CONFIG_OPTS_SETTERS', clear=True)
    ...
    @mock.patch.dict('escore.core.definitions.CONFIG_TYPES', clear=True)
    @mock.patch.dict('escore.core.definitions.USER_OPTS_CONF_KEYS', clear=True)
