# -*- coding: utf-8 -*-
#
# Eskapade Core documentation build configuration file for sphinx.
#
#
...
exclude_patterns = ['*test*', 'escore.tutorials.*']
...
htmlhelp_basename = 'EskapadeCoredoc'
...
latex_documents = [
    (master_doc, 'EskapadeCore.tex', 'Eskapade Core Documentation',
...
man_pages = [
    (master_doc, 'EskapadeCore', 'Eskapade Core Documentation',
     [author], 1)
]
