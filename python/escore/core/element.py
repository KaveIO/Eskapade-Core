...
from escore.core.mixin import ArgumentsMixin, TimerMixin
...
class Chain(Processor, ProcessorSequence, TimerMixin):
    ...
    def __exec(self, phase_callback) -> StatusCode:
        ...
        for _ in self:
            ...
            # Why would a link decide to skip the chain it is in during execution?
            # When an essential input collection is empty.
            ...
            # when looping over input file in chunks.
